define(function (require) {
  ...
  return function KibiSelectHelperFactory(
    ...
    const sparqlHelper = Private(require('ui/kibi/helpers/sparql_helper'));
    const sqlHelper = Private(require('ui/kibi/helpers/sql_helper'));
    const indexPath = Private(require('ui/kibi/components/commons/_index_path'));
    const datasourceHelper = Private(require('ui/kibi/helpers/datasource_helper'));
