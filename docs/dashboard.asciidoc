...
[float]
==== Removing filters and queries on all dashboards

To remove filters and queries on **all** dashboards, click the *Remove filters and queries from all dashboards* image:images/remove-all-filters.png[Minus] button in the toolbar panel.
