 ...
 */
export function getUiSettingsServiceForRequest(server, status, request, options = {}) { // kibi: pass status
  ...
  const uiSettingsService = uiSettingsServiceFactory(server, status, { // kibi: pass status
    readInterceptor,
    getDefaults,
