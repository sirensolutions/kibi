...
- copy the `config` directory from the previous installation to the new one
...
The Search Guard 5 plugin replaces the previous Search Guard 2 and Search Guard
SSL plugins; to find out the version of Search Guard 5 compatible with your
...
Populate config from /home/admin/es/configbak
Will update 'config' with ../elasticsearch.old/configbak/sg_config.yml
   SUCC: Configuration for 'config' created or updated
Will update 'roles' with ../elasticsearch.old/configbak/sg_roles.yml
   SUCC: Configuration for 'roles' created or updated
Will update 'rolesmapping' with ../elasticsearch.old/configbak/sg_roles_mapping.yml
   SUCC: Configuration for 'rolesmapping' created or updated
Will update 'internalusers' with ../elasticsearch.old/configbak/sg_internal_users.yml
   SUCC: Configuration for 'internalusers' created or updated
Will update 'actiongroups' with ../elasticsearch.old/configbak/sg_action_groups.yml
...
This section describes all the changes required to the Search Guard
configuration files; once the files have been modified, the configuration can
...
- add the following permission on the Kibi index (`.kibi` by default):
