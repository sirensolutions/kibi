define(function (require) {
  ...
  return function KibiSpyDataFactory(Promise, $http) {
    ...
    KibiSpyData.prototype.getDuration = function () {
      return this.duration;
    };

    KibiSpyData.prototype.setDuration = function (duration) {
     ...
     */
    KibiSpyData.prototype.add = function ({ index, type, query, meta, response, pruned }) {
    ...
    KibiSpyData.prototype.getFilterjoinStats = function (item) {
      const yes = {
    ...
    KibiSpyData.prototype.hasFilterjoinStats = function (item) {
      return item.response.coordinate_search && item.response.coordinate_search.actions.length;
    };

    KibiSpyData.prototype.translateQueries = function () {
