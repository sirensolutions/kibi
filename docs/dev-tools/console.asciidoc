...
.The Console UI
image::images/console/introduction_screen.png[Screenshot]
...
[[suggestions]]
.API suggestions
image::images/console/introduction_suggestion.png["Suggestions",width=400,align="center"]
...
[[action_menu]]
.The Action Menu
image::images/console/introduction_action_menu.png["The Action Menu",width=400,align="center"]

When the response come back, you should see it in the left hand panel:

.The Output Pane
image::images/console/introduction_output.png[Screenshot]
