...
In order to migrate to Kibana 6, your Kibana index needs to be reindexed. This will make transformations to the data model, removing types which are being {elastic-ref}/removal-of-types.html[removed in Elasticsearch].
