      ...
      bdd.describe('shared link', function () {
        ...
        bdd.it('should show the correct formatted URL', function () {
          ...
          var expectedUrl = baseUrl
            ...
            + '-23T18:31:44.000Z%27))&_k=(s:%27c46f29539d%27)&_a=(columns:!(_source),index:%27logstash-'
          ...
          .then(function (actualUrl) {
            ...
            expect(actualUrl.replace(/_t=\d{13}/,'_t=TIMESTAMP').replace(/s:%27\w{10}%27/,'s:SESSION_ID'))
              .to.be(expectedUrl.replace(/_t=\d{13}/,'_t=TIMESTAMP').replace(/s:%27\w{10}%27/,'s:SESSION_ID'));
          })
          .catch(common.handleError(this));
        });
