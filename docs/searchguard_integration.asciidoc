...
Once you log into Kibi, you can configure roles as needed from Kibi's Access Control section. You can find an example role below.
See the <<access_control_app, Access control app>> section for more information.
