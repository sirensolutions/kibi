...
Now **Log4J** configuration file is optional for Gremlin server. If you want to use your own custom configuration, you can specify path to your file by insert _kibi_core.gremlin_server.log_conf_path_ parameter inside your _kibi.yml_ file.
Here an example of how to configure _log4j.properties_ file for your Gremlin server:
```properties
