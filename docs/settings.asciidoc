...
export or import sets of searches, visualizations, dashboards, objects, configuration, and index-patterns.
...
. Go to *Settings > Objects*.
. Select the type of object you want to export. You can export a set of searches, visualizations, dashboards, objects, configuration, and index-patterns.
...
IMPORTANT: If you need to export every object you have in your Kibi installation, you can use button "Export Everything".

WARNING: Exported dashboards do not include their associated index patterns (only without "Export Everything" function). Re-create the index patterns manually before
