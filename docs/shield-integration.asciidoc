...
. Otherwise, you can edit _kibi.yml_ to enable ssl between Gremlin and Kibi:
+
----
kibi_core:
  load_jdbc: true
...
----
* Otherwise, if we want SSL between Kibi and Gremlin server, "kibi.yml" should look like*
----
kibi_core:
  load_jdbc: true
  datasource_encryption_algorithm: 'AES-GCM'
