...
engine instead.
* _kibi-html-angular_: this template for each document displays a panel populated with all property values (Currently supported only in Enhanced search results visualisation)
