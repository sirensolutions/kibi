...
+
image::images/time-filter.png[Time filter shortcuts]
...
+
image::images/time-filter-relative.png[Relative time filter]
...
+
image::images/time-filter-absolute.png[Absolute time filter]
