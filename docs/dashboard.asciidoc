...
[float]
==== Removing filters on all dashboard

To remove filters on **all** dashboards, click the *Remove all filters* image:images/remove-all-filters.png[Minus] button in the toolbar panel.
