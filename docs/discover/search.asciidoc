...
query syntax], or use the full JSON-based {elastic-ref}/query-dsl.html[Elasticsearch
Query DSL].
...
{elastic-ref}/query-dsl-query-string-query.html#query-string-syntax[query string syntax]
