import { formatMsg } from '../_format_msg';
...
describe('formatMsg', function () {
  ...
  describe('Kibana tests', function () {
    ...
    it('should handle a Angular $http error generated by an aborted request', function () {
      const err = {
        status: -1,
        data: null,
        config: {}
      ...
      expect(actual).to.equal('An error occurred while performing a request, please check your connection.');
    });
