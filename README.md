...
Kibi extends Kibana 4.4.0 with data intelligence features; the core feature of
...
A pre-configured Kibi is now running at [http://localhost:5606](http://localhost:5602);
