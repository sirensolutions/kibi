...
<<relational-filter,Kibi Relational filter>>:: Apply cross-dashboard filters
based on the relations between different indexes.
...
{elastic-ref}search-aggregations.html#_metrics_aggregations[metric] and {elastic-ref}search-aggregations.html#_bucket_aggregations[bucket] aggregations used in your
