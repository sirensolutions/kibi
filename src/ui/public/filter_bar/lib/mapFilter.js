define(function (require) {
  ...
  return function mapFilterProvider(Promise, Private) {
    ...
    let mappers = [
      ...
      Private(require('ui/kibi/filter_bar/lib/map_db_filter')), // kibi: map dbfilter, filters from external datasources
      Private(require('ui/kibi/filter_bar/lib/map_join_filter')), // kibi: map siren join filter
