module.exports = function (grunt) {
  ...
  const archives = [
    {
      url: 'https://github.com/sirensolutions/kibi_radar_vis/releases/download/5.4.0/kibi_radar_vis-5.4.0-1.zip',
      dest: `${tempFolder}/kibi_radar_vis.zip` // siren: Add temp folder location to filepath
    },
    {
      url: 'https://github.com/sirensolutions/kibi_timeline_vis/releases/download/5.4.0-1/kibi_timeline_vis-5.4.0-2.zip',
