...
federateserver:
  ...
  indices:
    ...
    '*':
      '*':
        - "indices:admin/exists"
        - "indices:admin/siren/connector/index/*"
...
sirenalert:
  hash: $2a$12$zMeFc6Xi.pcgDVHsvtCV9ePNteVwTE5uGxcKdf7XQcKB9.VkD8iOy
# users kept for backward compatibility reasons
kibiserver:
  hash: $2a$12$zMeFc6Xi.pcgDVHsvtCV9ePNteVwTE5uGxcKdf7XQcKB9.VkD8iOy
kibiadmin:
  hash: $2a$12$zMeFc6Xi.pcgDVHsvtCV9ePNteVwTE5uGxcKdf7XQcKB9.VkD8iOy
...
set the `elasticsearch.ssl.certificateAuthorities` to the path of the CA chain bundle in PEM
format, e.g.:
...
To enable certificate verification, set _elasticsearch.ssl.verificationMode_ to full,
e.g.:
