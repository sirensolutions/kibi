...
This list of plugins is not guaranteed to work on your version of Kibi. Instead, these are plugins that were known to work at some point with Kibi *5.x*. The Kibi installer will reject any plugins that haven't been published for your specific version of Kibi.
...
* https://github.com/nyurik/kibana-vega-vis[Vega-based visualization with map support] (nyurik)
