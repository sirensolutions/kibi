...
Kibi is currently developed as a fork of Kibana 4.4.0. The plugin API of https://www.elastic.co/blog/kibana-4-3-1-and-4-2-2-and-4-1-4[Kibana 4.2.x] allows us to keep the amount of forked code to a minimum, but as the API is currently in development, a fork is still needed.
...
- Kibi is merged with https://www.elastic.co/blog/kibana-4-4-0[Kibana 4.4.0] which introduced a major refactoring of the code.
