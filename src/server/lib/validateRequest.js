...
validate.Fail = function () {
  this.message = 'Kibana only supports modifying the "' + config.kibana.kibana_index +
  '" index. Requests that might modify other indices are not sent to elasticsearch.';
};
