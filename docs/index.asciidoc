...
:vanguard-website: https://docs.support.siren.io/5.4.3-1/vanguard/
:version: 5.4.3-4-SNAPSHOT
...
:searchguard-setup-ref: https://github.com/floragunncom/search-guard/tree/es-5.5.2
...
:version: 5.4.3-4-SNAPSHOT
:compatible-es-versions: 5.4.3, 5.5.2, 5.6.3
