...
[source,shell]
----
$ wget --ca-certificate=../kibi/pki/searchguard/ca.pem --http-user=sirenserver --http-password=password -qO - https://localhost:9220
----
...
Edit _config/kibi.yml_ and specify the credentials of the **sirenserver**
user, e.g.:
...
credentials in the `kibi_access_control.sirenalert` section, e.g.:
