...
To add a visualization to the dashboard, click the *Add Visualization* image:images/add-visualisation-button.png[Plus]
...
<<dashboard-groups-edit, Edit Groups>> button at the bottom of the dashboards menu.

[[dashboard-groups-edit]]
=== Edit Dashboard Groups

image::images/dashboard/dashboard-groups-edit.png["Dashboard Groups Edit Panel",align="center"]

In the Dashboard Group Edit Panel, you can change the order of the dashboard groups, move dashboards between groups by dragging and dropping from one group to another, <<dashboard-group-edit, change group titles and icons>>.
To create a new group, click the new group button at the bottom of the panel.
To <<dashboard-group-edit,edit an existing group>>, click the pencil icon.
...
Here, you can change the title of an existing group, set the icon to a custom image by inserting a URL or use a https://fortawesome.github.io/Font-Awesome/[Font Awesome] icon.
